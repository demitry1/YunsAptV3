                                    ...
                                    <table class="table table-hover table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="/notice/noticeDetail">사이트가 오픈되었습니다 ${i} <span class="badge rounded-pill bg-success">New</span> </a></td>
                                                <td class="text-center text-warning-color"><i class="fas fa-link"></i></td>
                                                <td class="text-center">demitry</td>
                                                <td class="text-center">2021-09-04</td>
                                                <td class="text-right"><fmt:formatNumber value="${i}"/> </td>
                                            </tr>
                                            </c:forEach>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="../notice/detail?id=${n.id }&page=${param.page}&nSearch=${param.nSearch}&nFindSel=${param.nFindSel}&h=${n.hit}">${n.title }</a></td>
